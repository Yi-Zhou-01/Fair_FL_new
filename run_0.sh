...
# Client partition
python src/partition.py --partition=diri --n_clients=10 --target_attr=income
...
python src/federated_main.py --model=mlp --dataset=adult --epochs=2 --num_users 10 --frac 0.1 --local_ep 2 --fl "new" --post_proc_cost "fpr"
